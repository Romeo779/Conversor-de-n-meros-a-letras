class Converter {
    ...
    getName(number) {
        ...
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 13) {
        ...
        if (number.length < 25) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 18, 'trillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 31) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 24, 'cuatrillón');       
        }//Númeo total del siguiente digito, incluyendo el 1        
         if (number.length < 37) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 30, 'quintillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 43) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 36, 'sextillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 49) {       //Cantidad de ceros que tiene 
            return this.getPeriod(number, 42, 'septillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 55) {       //Cantidad de ceros que tiene         
            return this.getPeriod(number, 48, 'octillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 61) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 54, 'nonillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 67) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 60, 'decillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 73) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 66, 'undecillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 79) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 72, 'duodecillón');
        }//Númeo total del siguiente digito, incluyendo el 1
         if (number.length < 85) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 78, 'tredecillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 91) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 84, 'cuatordecillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 97) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 90, 'quindecillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 103) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 96, 'sexdecillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 109) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 102, 'septendecillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 115) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 108, 'octodecillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 121) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 114, 'novendecillón');
        }//Númeo total del siguiente digito, incluyendo el 1
        if (number.length < 127) {       //Cantidad de ceros que tiene
            return this.getPeriod(number, 120, 'vigintillón');
        }
